...
There's also a VSCode Web Client, instructions to set this up can be found [here](../tricks/index.md#vs-code-web)
...
#### Step 3: Connect
Once you take your valid crave.conf, just connect using `crave -n devspace` and return to the [previous guide](./4.-Setting-Project.md)
