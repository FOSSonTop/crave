...
- ***Do not abuse crave clone and crave clone destroy***. This is just continuation of --clean rule. if you're building the same rom and only have device changes, make installclean(included in the crave run command) is enough.
